...
$checkl = true;
$kinfos = $c->Showkinfo($_GET['kid']);
$leerlingen = $c->Showkleerlingen($_GET['kid']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>project 2 - verandering bestemming</title>
...
<div id="wrapper">
	...
	<input type="submit" class="link" name="dest" value="keuze bbevestigen"/>
	</form>
	</article>
	</div>
</body>
